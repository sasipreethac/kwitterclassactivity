...
function updateLike(message_id)
{
  ...
  console.log("Inside updatelike - button_id",button_id);
  likes = document.getElementById(button_id).value;
  console.log("information in likes variable",likes);
	updated_likes = Number(likes) + 1;
	console.log("Like inside updatelike function",updated_likes);
